// src/lib.rs
/*
 * Core library for GraphProtocol
 */
...
#[derive(Debug)]
pub struct GraphProtocolProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GraphProtocolProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GraphProtocol processing");
    
    let mut processor = GraphProtocolProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GraphProtocolProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GraphProtocolProcessor::new(false);
